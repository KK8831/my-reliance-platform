...
export default function DailyPlanCard({ plan, onBuy }) {
  return (
      ...
      <div className="plan-info">
        ...
        <div className="plan-stats-grid">
           <div className="plan-stat">
             ...
             <span className="stat-val red">{formatCurrency(plan.dailyEarnings || plan.hourlyEarnings)}</span>
           </div>
           <div className="plan-stat">
             <span className="stat-label">Revenue Days</span>
             <span className="stat-val blue">1 Days</span>
           </div>
